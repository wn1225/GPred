...
#         score_total.extend(result.detach().cpu().numpy())
#         label = data.label.float()
#         label = label.unsqueeze(1)
...
# with open('./data/result/result_' + str(fold) + '_pcbep_bceloss_only_atom5_0.89_m.txt', 'w') as f:
