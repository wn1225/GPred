...
for fold in [0, 1, 2, 3, 4]:
    ...
    m, neg_num, pos_num = weight(ion, residus, folds_t[fold])
...
avg_AUC = avg_AUC / 5
avg_AP = avg_AP / 5
ff.write('avg_AUC: ' + str(avg_AUC))
ff.write('avg_AP: ' + str(avg_AP))
print('avg_AUC: ' + str(avg_AUC))
print('avg_AP: ' + str(avg_AP))
