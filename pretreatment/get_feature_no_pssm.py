...
def main():
    ...
    ff = open(feature + 'feature_no_pssm_test.txt', 'w')

    label_file = label + 'label_test.txt'

    surface_file = surface + 'cd_test_surface_total.txt'
    ...
    with open(label_file, 'r') as fp, open(surface_file) as fp3:
        ...
        for line1 in fp:  # line1:str '>3jcx-A\n'
            ...
            if line1.startswith('>'):
                ...
                seq = row1[0][6]
                file = ipath + 'one_pdb/' + file_name + '_' + seq + '.pdb'
                ...
                try:
                    ...
                    print(file_name + '\n')
    print("done extracting featuren no pssm")
